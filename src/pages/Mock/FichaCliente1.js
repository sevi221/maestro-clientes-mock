...
import CamposCore1 from "../../components/CamposCore/CamposCore1";
import BasicData1 from "../../components/BasicData/BasicData1";
...
class FichaCliente1 extends Component {
  render() {
    return (
      <React.Fragment>
