...
const urlMockResumen =
  "https://ficha-cliente-v4.getsandbox.com/clientes/interlocutor/9980013084/datos/generales";
// "http://www.mocky.io/v2/5ea198bd31000056291eec46";
// CLIENTE COMERCIAL CCTOP
class CamposCore1 extends Component {
  state = {
    resumen: [],
    basico: [],
    status: null,
        ...
        <Card>
          <Row>
            <Col span={24}>
              ...
              <Title level={4}>
                Gestor Comercial: {this.state.resumen.gestorComercial}{" "}
              </Title>
              <Title level={4}>Sector CNAE:{this.state.basico.codCnae}</Title>
              <Title level={4}>
                Total facturación anual:
                {this.state.resumen.facturacionAnual}€
              </Title>
            </Col>
          </Row>
        </Card>
